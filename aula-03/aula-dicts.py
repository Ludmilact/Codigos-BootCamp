...
# Começam com {} e tem: que dividem os pares de chave: valor e vírgula separando um par de chave e outro de valor
...
# O resultado é o mesmo dicionário da linha 13

sigla_estado = dict(SP = "São Paulo", MG = "Minas Gerais")
print(f"Dicionario inicial: {sigla_estado}")
...
# Caso uma chave não exista, o código gera um erro. Descomente a linha 28 abaixo e execute o código
...
#-----------------------------------------------------------------------------------------------------------------
### METODOS MAIS COMUNS DE DICIONÁRIOS
...
print(f"\nTransformando as chaves em outro objeto: {sigla_estado.keys()}")
