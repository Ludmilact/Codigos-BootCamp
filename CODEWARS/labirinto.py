...
def main():
    ...
    posiveis_direcoes = [ESQUERDA, DIREITA, CIMA, BAIXO]
    ...
    while POSICAO_ATUAL != POSICAO_FINAL:
        ...
        for direcao in posiveis_direcoes:
            ...
            # passo a possição atual e a direção da vez no "for" para a funçao "verifica_movimento" que verifica se o mov. é possivel
            if verifica_movimento(POSICAO_ATUAL, direcao): 
                ...
                print_labirinto()
                sleep(1)
            # elif LABIRINTO[POSICAO_ATUAL[0]] [POSICAO_ATUAL[1]] == SAIDA :
